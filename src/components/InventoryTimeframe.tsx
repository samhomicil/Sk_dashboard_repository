...
// Timeframe control for the whole inventory module — mirrors the dashboard's Period model
// (resolveDateRange). Writes the choice to the URL so every tab re-scopes together.
export default function InventoryTimeframe() {
