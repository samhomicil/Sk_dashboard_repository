...
function Style() {
  return (
    ...
    tr.bk{cursor:pointer;} @media (hover:hover){tr.bk:hover .rowlab,tr.bk:hover td{background:var(--elev);}} tr.bk .rowlab{padding:10px 12px;border-top:1px solid var(--line);}
